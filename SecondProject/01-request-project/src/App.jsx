...
function App() {
  ...
  async function handleSelectPlace(selectedPlace) {
    ...
    try {
      ...
      setUserPlaces(userPlaces); //optimisticUpdate: cập nhật trạng thái trước đó của state thay vì hiển thị các đoạn văn bản loading hay icon loading, tùy vào tình huống mới sử dụng
      //trường hợp ở đây là cập nhật lại state trc khi sau khi gửi request updateUserPlace và trc khi nhận đc resp của nó
